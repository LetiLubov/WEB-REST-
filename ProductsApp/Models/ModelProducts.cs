...
namespace ProductsApp.Models
{
    ...
    {
        static public Product GetProductByKeyword(String htmlHref)
        {
            Product p = new Product(); //  главный товар 
        ...
        static Product isProductInDB(int parameter) //в nosql проверяем наличие товара и выдаем инфу, если есть
        {
        ...
        static Product FindInfoAboutProductWithPasrsingUlmart(String parameter) //неделима. Получает инфу о товаре. 
        {
            HtmlDocument document = null;
            HtmlWeb web = new HtmlWeb();
        ...
        static  void InsertInLiteDB(Product p) //в nosql проверяем наличие товара и выдаем инфу, если есть
        {
